	...
	<body onKeyPress="return checkSubmit(event)">
		...
		<form name="nom_cathedral_edit_form" method="post">
			...
			<div class="edit" id="userInfo">
				<div class="edit_form">
					<label>№ <input readonly type="text" name="id" required="Y" id="id" readonly value="<?= $currCathedral->getId()?>"/> </label>
					<label>Код <input type="text" required="Y" name="shortName" id="shortName" value="<?= $currCathedral->getShortName()?>"/> </label>
